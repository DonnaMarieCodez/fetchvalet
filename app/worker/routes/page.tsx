...
function normalizeRoute(row: unknown): RouteRecord {
  ...
  return {
    id: String(record.id ?? ""),
    route_date: typeof record.route_date === "string" ? record.route_date : null,
    ...
    minimum_worker_score:
      typeof record.minimum_worker_score === "number"
        ...
        : 0,
    claimed_by: typeof record.claimed_by === "string" ? record.claimed_by : null,
          ...
          <div className="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
            <div className="max-w-3xl">
              ...
              <p className="mt-3 text-slate-200">
                Claim open routes that match your worker score and manage the
                routes already assigned to you.
              </p>
            </div>
            ...
            <div className="mt-5 space-y-4">
              {typedAvailableRoutes.length === 0 ? (
                ...
                typedAvailableRoutes.map((route) => (
                  <div key={route.id} className="rounded-2xl border bg-slate-50 p-5">
